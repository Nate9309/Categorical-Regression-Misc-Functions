...
# 1. polrLogitStdCoef() # X standardized coefficients for ordinal logit models from the MASS package
# 2. mlogTestR() # does Wald and Likelihood ratio tests of joint significance for multinomial logitmodels from the mlogit package
